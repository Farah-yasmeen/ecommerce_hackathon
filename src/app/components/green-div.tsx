...
export default function GreenDiv() {
    return (
        <div className="w-[1440px] rounded-[5px] absolute bg-[#23856D] mt-[-130px] top-[3200px] left-1/2 transform -translate-x-1/2 border">
            <div className="w-[1440px] h-[709px]">
                <div className="w-[1440px] h-[709px]">
                    <div className="w-[1036px] h-[711px] py-[112px] flex gap-[80px]">
